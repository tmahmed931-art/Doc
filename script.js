// script.js - النسخة النهائية مع ضمان ظهور التمارين والعلامة المائية
document.addEventListener('DOMContentLoaded', () => {
    ...
    // تحميل التمارين إذا كنا في صفحة التمارين
    if (document.getElementById('exercisesGrid')) {
        loadExercises();
        setupFilterButtons();
    }

    // تحميل المكملات إذا كنا في صفحة المكملات
    if (document.getElementById('supplementsGrid')) {
        loadSupplements();
    }

    // إعداد حاسبة السعرات إذا كنا في صفحة الحاسبة
    if (document.getElementById('calcBtn')) {
        setupCalculator();
    }

    // إضافة العلامة المائية "Momo" تلقائياً في كل الصفحات
...
function loadExercises() {
    ...
    if (!grid) {
        console.error('لم يتم العثور على عنصر exercisesGrid');
        return;
    }
